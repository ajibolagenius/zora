...
import { LazyImage, LazyAvatar, QuantitySelector, StatusBadge, RatingDisplay } from '../../components/ui';
...
export default function ProductScreen() {
    ...
    // Fetch product data on mount and when slug changes
    useEffect(() => {
        fetchData();
    }, [fetchData]);
                                ...
                                renderItem={({ item }) => (
                                    <View style={[styles.heroSection, { height: screenHeight * 0.45, width: screenWidth }]}>
                                        <View style={styles.heroImage}>
                                            ...
                                            />
                                            <LinearGradient
                                                colors={[Colors.black40, 'transparent', Colors.black60]}
                    ...
                    <View style={[styles.heroHeader, { paddingTop: insets.top + 12 }]}>
                        ...
                        <View style={styles.heroHeaderRight}>
                            ...
                            >
                                <Heart
                                    size={20}
                                    color={product && isInWishlist(product.id) ? Colors.primary : Colors.textPrimary}
                ...
                <View style={styles.contentCard}>
                    ...
                    >
                        {product.certifications?.includes('Organic') && (
                            <StatusBadge type="organic" size="medium" showIcon />
                        )}
                        {product.rating >= 4.5 && (
                            <StatusBadge type="topRated" size="medium" showIcon />
                        )}
                        {product.certifications?.includes('Eco-friendly') && (
                            <StatusBadge type="ecoFriendly" size="medium" showIcon />
                        )}
                    </ScrollView>
                        ...
                        >
                            ...
                            <View style={styles.vendorInfo}>
                                <View style={styles.vendorLabelRow}>
                                    ...
                                    {vendor.is_verified && (
                                        <SealCheck size={14} color={Colors.info} weight="fill" />
                                    )}
                                </View>
