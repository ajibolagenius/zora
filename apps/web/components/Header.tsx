        ...
        <nav className={`fixed top-0 left-0 right-0 z-50 ${bgClass} backdrop-blur-md`} role="navigation" aria-label="Main navigation">
            <div className="container mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <Link href="/login" className={`hidden sm:inline-flex ${linkClass} px-4 py-2 text-sm font-medium transition-colors`}>
                        Sign In
                    </Link>
                    <Link
            ...
            {mobileMenuOpen && (
                <div className={`lg:hidden ${variant === "dark" ? "bg-background-dark border-white/10" : "bg-white border-gray-200"} border-t shadow-lg`}>
                    <div className="container mx-auto px-4 py-4 flex flex-col space-y-2">
                        ...
                        <Link href="/login" onClick={() => setMobileMenuOpen(false)} className={`px-4 py-3 text-base font-medium ${linkClass} rounded-lg transition-colors`}>
                            Sign In
                        </Link>
                        <Link
                            href="/vendor-onboarding"
