...
import {
    ...
    Bell, Shield, Globe, ArrowUpRight, Smartphone, BarChart3,
    MessageSquare, Zap, Package, Star, Clock
} from "lucide-react";

export default function FeaturesPage() {
    const features = [
        { icon: Search, title: "Smart Search", desc: "Find by name, vendor, or region", color: "bg-blue-100 text-blue-600" },
        { icon: Globe, title: "Shop by Region", desc: "5 African regions to explore", color: "bg-orange-100 text-orange-600" },
        { icon: ShoppingBag, title: "Multi-Vendor Cart", desc: "One checkout for all vendors", color: "bg-purple-100 text-purple-600" },
                    ...
                    <div className="grid grid-cols-12 gap-3 md:gap-4">
                        ...
                        <div className="col-span-12 md:col-span-6 bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-5 md:p-6 text-white">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-4">
                                {[
                                    ...
                                    { icon: Smartphone, text: "Native apps" },
                        ...
                        <div className="col-span-12 md:col-span-6 bg-white rounded-2xl p-5 md:p-6 border border-gray-100">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {[
                                    { icon: BarChart3, title: "Analytics", color: "bg-blue-100 text-blue-600" },
                                    { icon: Package, title: "Inventory", color: "bg-green-100 text-green-600" },
                                    { icon: MessageSquare, title: "Messaging", color: "bg-purple-100 text-purple-600" },
                            ...
                            <Link href="/vendors" className="inline-flex items-center gap-2 text-primary font-medium text-sm mt-4 hover:underline">
                                Learn more about selling <ArrowUpRight className="w-4 h-4" />
                            </Link>
                        </div>
                    </div>
                </div>
