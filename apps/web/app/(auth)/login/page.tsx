...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-surface-light py-12 px-4">
            <div className="max-w-md w-full">
                <div className="text-center mb-8">
                    <Link href="/" className="text-3xl font-bold font-display text-primary">
                        ZORA
                    </Link>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <div className="mt-6">
                        ...
                        <button className="mt-4 w-full flex items-center justify-center gap-3 bg-white border border-border py-3 rounded-xl font-medium hover:bg-gray-50 transition-colors">
