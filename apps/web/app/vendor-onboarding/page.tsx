    ...
    return (
        <main className="min-h-screen bg-background-light">
            ...
            <div className="max-w-2xl mx-auto">
                <Card className="bg-white rounded-2xl shadow-lg border border-border p-6">
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold text-text-dark mb-4">Start Your Vendor Journey</h2>
                        <p className="text-muted-foreground">Complete the form below to begin selling on Zora.</p>
                    </div>
