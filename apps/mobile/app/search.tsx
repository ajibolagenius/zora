                                ...
                                <View className="gap-2">
                                    {SORT_OPTIONS.map((option) => (
                                        <TouchableOpacity
                                            ...
                                            className={`flex-row items-center justify-between p-3 rounded-lg ${tempFilters.sortBy === option.id ? 'bg-zora-red/20' : 'bg-card-dark'
                                                }`}
                                        >
...
function FilterChip({
    ...
    return (
        <TouchableOpacity
            onPress={onPress}
            className={`px-4 py-2 rounded-full ${selected ? 'bg-zora-red' : 'bg-card-dark'
                }`}
            activeOpacity={0.8}
        >
